                    ...
                    <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kendall Goit</h3>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h3>What does the program mean to you?</h3>
                                        ...
                                        <h3>Biggest life-lesson you are learning/learned from MSU?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Amanda Ling</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Mary Rozman Mueting</h3>
                                        <span className="sponsor__meta">Class of 1987</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Olivia Starzomski</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Peter Corsetti</h3>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Nick Leshok</h3>
                                        <span className="sponsor__meta">Class of 2018</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Adam Pawlick</h3>
                                        <span className="sponsor__meta">Class of 1994</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Joni Leete</h3>
                                        <span className="sponsor__meta">Class of 2000</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Sophia Balow</h3>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Pruitt Walther</h3>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Alex Duffy</h3>
                                        <span className="sponsor__meta">Class of 2018</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Ana Sortland</h3>
                                        <span className="sponsor__meta">Class of 2019</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kelley Heron</h3>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Dianne Oliver Johnson</h3>
                                        <span className="sponsor__meta">Class of 2000</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kelsey (Buese) Chisholm</h3>
                                        <span className="sponsor__meta">Class of 2016</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Mindy Arbaugh</h3>
                                        <span className="sponsor__meta">Class of 1996</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Abbey Neveling</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Sidney Appelboom</h3>
                                        <span className="sponsor__meta">Class of 1989</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
...
Go Green Go white.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Ava Boutrous</h3>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Cristofer Gore</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">David Habel</h3>
                                        <span className="sponsor__meta">Class of 2006</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Cyrus Irwin</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Ellie Roche</h3>
                                        <span className="sponsor__meta">Class of 2019</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                                        Opportunity
...
Now, I’m back in my home state coaching for the community that I was a part of for 13 years. My heart has been broken once again as I witnessed my own Alma mater make the same irrational decision to discontinue their swim & dive team. My heart aches for the future of all swim communities- small and large. If we’re not safe in small states like ND or on the B1G stage, then where are we safe? Which team will be next? I want more for the future of college swimming.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">David Burgering</h3>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Erin Szara</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Erica Kunnen (Cutler)</h3>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Haley Kornburger</h3>
                                        <span className="sponsor__meta">Class of 2018</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Emma Inch</h3>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Jakob Heberling</h3>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">James Gavin</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Josh Pascua</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Jessica Cutler</h3>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Julia Coffman</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kasey Venn</h3>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kayla (Kalmbach) Williams</h3>
...
The phrase Spartans will really resonates with me. It speaks to the determination of our student athletes, and the Swim and Dive team embodies this phrase more than most. They have been achieving in spite of the obstacles and doing more with less for a long time. They perform well both in the classroom and in the pool. I would not be as successful as I am today without the opportunity to dive at MSU.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Kerry Sodonis</h3>
                                        <span className="sponsor__meta">Class of 2012</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Liz Lawless (Herrington)</h3>
                                        <span className="sponsor__meta">Class of 2008</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Nicole Egan</h3>
                                        <span className="sponsor__meta">Class of 1994</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Marcella Steffes</h3>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Olivia Chick</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Phillip Meffert</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Rusty Jerger</h3>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Rachel Aycock</h3>
                                        <span className="sponsor__meta">Class of 2020</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Stephan Freitag</h3>
                                        <span className="sponsor__meta">Class of 2025</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Stephanie Merkey Slye</h3>
                                        <span className="sponsor__meta">Class of 2001</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Taylor Contino</h3>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Summer (Strickler) Weiss</h3>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Terry Inch</h3>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Trish Simon</h3>
                                        <span className="sponsor__meta">Class of 1987</span>
                                        <h3>What does the program mean to you?</h3>
                                        <p className="sponsor__text">
                                        The program was my instant family away from home. It gave me some of the best experiences of my life with travel, relationships, Varsity Club community work and interaction with other sports teams. The team was a source of strength, community and humor and has remained a touchstone to MSU, all these years later.                                        </p>
                                        <h3>Why did you choose MSU?</h3>
                                        <p className="sponsor__text">
                                        MSU was an hour from my hometown and my teenage coach contacted the MSU coach, who invited me to campus for a visit. While I was not provided a scholarship, I chose MSU to be part of such a great university.                                        </p>
                                        <h3>Biggest life-lesson you are learning/learned from MSU?</h3>
                                        <p className="sponsor__text">
                                        Life is full of difficult choices, which you can navigate successfully, particularly with the support of friends. Work for what you want. You never know who your next life-long friend may be. Embrace the opportunities you meet.                                        </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Ricky Forrest</h3>
                                        <span className="sponsor__meta">Class of 2011</span>
                                        <p className="sponsor__text">
...
Please consider this; what athletes do at Michigan State goes beyond their time in college. It is a journey that give every student athlete an opportunity to grow and become a success.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h3 className="sponsor__title">Dylan Mahoney-Muno</h3>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <p className="sponsor__text">

                    ...
                    <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kendall Goit</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Amanda Ling</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Mary Rozman Mueting</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Olivia Starzomski</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Peter Corsetti</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Nick Leshok</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Adam Pawlick</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Joni Leete</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Sophia Balow</h4>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Pruitt Walther</h4>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Alex Duffy</h4>
                                        <span className="sponsor__meta">Class of 2018</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Ana Sortland</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kelley Heron</h4>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Dianne Oliver Johnson</h4>
                                        <span className="sponsor__meta">Class of 2000</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kelsey (Buese) Chisholm</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Mindy Arbaugh</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Abbey Neveling</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Sidney Appelboom</h4>
...
Go Green Go white.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Ava Boutrous</h4>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Cristofer Gore</h4>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">David Habel</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Cyrus Irwin</h4>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Ellie Roche</h4>
                                        <span className="sponsor__meta">Class of 2019</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                                        Opportunity
...
Now, I’m back in my home state coaching for the community that I was a part of for 13 years. My heart has been broken once again as I witnessed my own Alma mater make the same irrational decision to discontinue their swim & dive team. My heart aches for the future of all swim communities- small and large. If we’re not safe in small states like ND or on the B1G stage, then where are we safe? Which team will be next? I want more for the future of college swimming.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">David Burgering</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Erin Szara</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Erica Kunnen (Cutler)</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Haley Kornburger</h4>
                                        <span className="sponsor__meta">Class of 2018</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Emma Inch</h4>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Jakob Heberling</h4>
                                        <span className="sponsor__meta">Class of 2022</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">James Gavin</h4>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Josh Pascua</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Jessica Cutler</h4>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Julia Coffman</h4>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kasey Venn</h4>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kayla (Kalmbach) Williams</h4>
...
The phrase Spartans will really resonates with me. It speaks to the determination of our student athletes, and the Swim and Dive team embodies this phrase more than most. They have been achieving in spite of the obstacles and doing more with less for a long time. They perform well both in the classroom and in the pool. I would not be as successful as I am today without the opportunity to dive at MSU.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Kerry Sodonis</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Liz Lawless (Herrington)</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Nicole Egan</h4>
                                        <span className="sponsor__meta">Class of 1994</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Marcella Steffes</h4>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Olivia Chick</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Phillip Meffert</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Rusty Jerger</h4>
                                        <span className="sponsor__meta">Class of 2024</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Rachel Aycock</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Stephan Freitag</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Stephanie Merkey Slye</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Taylor Contino</h4>
                                        <span className="sponsor__meta">Class of 2021</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Summer (Strickler) Weiss</h4>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Terry Inch</h4>
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Travis Nitkiewicz</h4>
                                        <span className="sponsor__meta">Class of 2023</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Trish Simon</h4>
                                        <span className="sponsor__meta">Class of 1987</span>
                                        <h4>What does the program mean to you?</h4>
                                        <p className="sponsor__text">
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Ricky Forrest</h4>
...
Please consider this; what athletes do at Michigan State goes beyond their time in college. It is a journey that give every student athlete an opportunity to grow and become a success.
                        ...
                        <div className="sponsor-wrap">
                            <div className="row">
                                ...
                                <div className="col-lg-9">
                                    <div className="sponsor-item">
                                        <h4 className="sponsor__title">Dylan Mahoney-Muno</h4>
                                        <span className="sponsor__meta">Class of 2014</span>
                                        <p className="sponsor__text">
